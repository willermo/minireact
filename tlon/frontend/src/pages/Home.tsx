    ...
    <div className="home-page">
      ...
      >
        <p className="text-xl my-1 text-justify">
          Welcome to the editing of this astonishing paragraph. Help yourself
          writing two lines of text instead than a loremipsum or an ai generated
          text, relax your fingers and I think that, yes, you should have
          written enough
        </p>
        <p className="text-xl my-1 text-justify">
          It's time to <strong>make something useful out of this</strong> —
          let's go!
        </p>
      </section>
      ...
      >
        ...
        >
          <p className="game-description-card h-[350px] overflow-y-auto px-4 py-4 text-lg font-medium rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/40 border border-blue-200 dark:border-blue-700 shadow-inner hover:shadow-blue-200 dark:hover:shadow-blue-700/30 transition duration-300">
            ...
            Time to test this <strong>great</strong> card content.
            <span className="block mt-2">
              No cap, this exercise <em>hits different</em> when you look at the
              screen and the screen looks at you.
            </span>
